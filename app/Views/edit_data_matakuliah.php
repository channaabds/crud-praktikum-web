...
<body>  
    ...
    <div class="container-xl card card-body shadow-sm p-1 pt-5 mt-2 mb-5 bg-body-tertiary rounded">
        <form method="POST" action="<?= base_url('proses_edit_matakuliah') ?>">
            <div class="container">
            <input type="hidden" name="id_matakuliah" class="form-control" id="id_mataKuliah" value="<?= $data_matakuliah->id_matakuliah ?>">
                <div class="row">
                    <div class="col-md-6">
                        <label for="mataKuliah" class="form-label"><b>Mata Kuliah</b></label>
                        <input type="text" name="matakuliah" class="form-control" id="mataKuliah" value="<?= $data_matakuliah->matakuliah ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="jam" class="form-label"><b>Jam</b></label>
                        <input type="text" name="jam" class="form-control" id="jam" value="<?= $data_matakuliah->jam ?>">
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-md-4">
                        <label for="semester" class="form-label"><b>Semester</b></label>
                        <input type="text" name="semester" class="form-control" id="semester" value="<?= $data_matakuliah->semester ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="hari" class="form-label"><b>Hari</b></label>
                        <input type="text" name="hari" class="form-control" id="hari" value="<?= $data_matakuliah->hari ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="ruang" class="form-label"><b>Ruang</b></label>
                        <input type="text" name="ruang" class="form-control" id="ruang" value="<?= $data_matakuliah->ruang ?>">
                    </div>
                </div>
                <div class="row mt-4">
